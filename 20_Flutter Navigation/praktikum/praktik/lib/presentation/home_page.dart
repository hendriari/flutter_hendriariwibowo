...
import 'package:praktik/data/contact_list_data.dart';
import 'package:praktik/data/contact_model.dart';
import 'package:praktik/presentation/contact_detail.dart';

class HomePage extends StatefulWidget {
  final String? detailNames;
  final String? detailNumbers;
  final String? detailBirtday;
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => ContactDetail(
                          ...
                          names: _names!,
                          numbers: _numbers!,
                          detailBirthday: _detailBirthday == null
                              ? 'No more data'
                              : _detailBirthday!,
                          detailHome: _detailHome == null
                              ? 'No more data'
                              : _detailHome!,
                        ),
                      ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.of(context).pushNamed('/addcontactinfo');
                        },
                        child: const Text(
                          'Add more info',
                        ),

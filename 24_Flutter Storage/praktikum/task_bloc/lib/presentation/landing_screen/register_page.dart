...
import 'package:task_bloc/presentation/landing_screen/landing_page.dart';
import 'package:task_bloc/presentation/landing_screen/login_page.dart';
import 'package:task_bloc/widget/back_button_widget.dart';
import 'package:task_bloc/widget/button_widget.dart';
import 'package:task_bloc/widget/platform_login.dart';
import 'package:task_bloc/widget/text_form_fields.dart';
import 'package:task_bloc/widget/text_have_account.dart';
import 'package:task_bloc/widget/text_register_widget.dart';
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: ButtonWidget(
                        onPressed: () async {
                          if (_key.currentState!.validate()) {
                            ...
                            await context.read<UserBloc>().setNewUser(users);
                  ...
                  //       context.read<UserBloc>().setNewUser(context, users);
    ...
    return showCupertinoDialog(
        ...
        builder: (context) {
          return CupertinoAlertDialog(
            ...
            content: const Text('This fiture will be Comming Soon !'),
            actions: [
